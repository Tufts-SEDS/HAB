...
// SDK -> constant file, esp->loging to monitor, freertos->task management,

#define I2C_MASTER_NUM I2C_NUM_0 // I2C port number for master dev

static const char *TAG = "bno test";
...
{
    ESP_LOGI(TAG, "Starting BNO test");
    i2c_bus_init();
    ESP_LOGI(TAG, "I2C bus initialization: good hopefully");
    static BNO055 bno(I2C_NUM_0, I2C_ADDR_BIT_LEN_7, 0x28, CONFIG_I2C_MASTER_FREQUENCY);
    ESP_LOGI(TAG, "BNO055 object initialized");
    bno.configure();
